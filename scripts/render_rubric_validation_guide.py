...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=Path(
            "/private/groups/corbettlab/gabe/auto_lit_eval_data/validation_manifests/rubrics"
        ),
    )
    args = p.parse_args()
    ...
    if args.rubrics:
        ...
        rubric_dir = Path("/private/groups/corbettlab/gabe/auto_lit_eval_data/rubrics")
    ...
    render_paths(paths, args.out_dir)
    return 0
