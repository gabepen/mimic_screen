...
hmmcleaner="perl /private/groups/corbettlab/gabe/mimic_screen/evorate_workflow/scripts/MACSE_V2_PIPELINES/UTILS/HMMcleanerV1_8_VR2/HMMcleanAA_VR.pl"
LG_HOME="/private/groups/corbettlab/gabe/mimic_screen/evorate_workflow/scripts/MACSE_V2_PIPELINES/UTILS"
macse="macse"
######################################

#create TMP dir
TMP_DIR="$OUT_DIR/__MCS_$PREFIX"
if [ ! -e  $TMP_DIR ]; then
  mkdir "$TMP_DIR"
fi
cd $TMP_DIR
...
IN_SEQ_FILE=$(basename "$IN_SEQ_FILE")
