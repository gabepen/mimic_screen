...
def main() -> int:
    ...
    parser.add_argument(
        "--data-root",
        default=None,
        help="Dataset root (default: AUTO_LIT_DATA_ROOT or sibling auto_lit_eval_data checkout).",
    )
    parser.add_argument(
        "--output-root",
        default="",
    ...
    data_root = Path(args.data_root) if args.data_root else auto_lit_data_root()
